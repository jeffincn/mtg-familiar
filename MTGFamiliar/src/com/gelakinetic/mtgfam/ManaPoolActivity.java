...
{
    private Button whiteMinus, blueMinus, blackMinus, redMinus,
            greenMinus, colorlessMinus, spellMinus;
    private Button whitePlus, bluePlus, blackPlus, redPlus,
            greenPlus, colorlessPlus, spellPlus;
    private TextView whiteReadout, blueReadout, blackReadout,
            redReadout, greenReadout, colorlessReadout,
            spellReadout;
    ...
    public void onCreate(Bundle savedInstance)
    {
        ...
        setContentView(R.layout.mana_pool);
        ...
        Button buttons[] = { whiteMinus, blueMinus, blackMinus,
            redMinus, greenMinus, colorlessMinus, spellMinus,
            whitePlus, bluePlus, blackPlus, redPlus, greenPlus,
            colorlessPlus, spellPlus };
        TextView readouts[] = { whiteReadout, blueReadout,
            blackReadout, redReadout, greenReadout,
            colorlessReadout, spellReadout };
    ...
    private void store()
    {
		SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(this);
        settings.edit()
            .putInt("whiteMana", white)
            .putInt("blueMana", blue)
            .putInt("blackMana", black)
            .putInt("redMana", red)
            .putInt("greenMana", green)
            .putInt("colorlessMana", colorless)
            .putInt("spellCount", spell)
            .commit();
    }
    ...
    private void update()
    {
        TextView readouts[] = { whiteReadout, blueReadout,
            blackReadout, redReadout, greenReadout,
            colorlessReadout, spellReadout };
        int values[] = { white, blue, black, red, green,
            colorless, spell };
