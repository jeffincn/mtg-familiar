...
public class ReversedLinesFileReader implements Closeable {
    ...
    public ReversedLinesFileReader(final File file, final int blockSize, final Charset encoding) throws IOException {
        ...
        newLineSequences = new byte[][] { "\r\n".getBytes(encoding.name()), "\n".getBytes(encoding.name()), "\r".getBytes(encoding.name()) };
            ...
            if (no > 1) {
                ...
                if (leftOver != null) {
                    throw new IllegalStateException("Unexpected leftover of the last block: leftOverOfThisFilePart="
                            + new String(leftOver, encoding.name()));
                }
                return null;
            }
        }
        ...
        private String readLine() throws IOException {
            ...
            while (i > -1) {
                ...
                if ((newLineMatchByteCount = getNewLineMatchByteCount(data, i)) > 0 /* found newline */) {
                    ...
                    line = new String(lineData, encoding.name());
            ...
            if (isLastFilePart && leftOver != null) {
                ...
                line = new String(leftOver, encoding.name());
                leftOver = null;
            }
