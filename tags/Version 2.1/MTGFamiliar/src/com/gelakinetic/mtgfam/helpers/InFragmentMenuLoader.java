 ...
 */
public class InFragmentMenuLoader {
	...
	public InFragmentMenuLoader(Context context) {
    	mView = new LinearLayout(context);
    	mView.setTag("FragmentMenu");
    	mView.setOrientation(LinearLayout.HORIZONTAL);
    	mView.setBackgroundResource(com.gelakinetic.mtgfam.R.color.in_fragment_menu_background_color);
     ...
     */
    @SuppressWarnings("deprecation")
	public InFragmentMenuLoader(Context context, Object realOwner) {
    	mView = new LinearLayout(context);
    	mView.setTag("FragmentMenu");
    	mView.setBackgroundColor(0x99333333);
    	mView.setOrientation(LinearLayout.HORIZONTAL);
    	mView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
    ...
    public InFragmentMenuLoader(SherlockFragment fragment) {
    ...
    private class MenuState {
        ...
        /*
         * itemTitle and itemIconResId are the important ones
         */
        private void setItem(MenuItem item) {
            ((InFragmentMenuItem)item).setChecked(itemChecked)
        ...
        /*
         * TODO Custom the shit out of this method
         */
        public void addItem() {
            itemAdded = true;
            View b;
            if(itemIconResId != 0) {
            	b = new ImageButton(mContext);
            	((ImageButton)b).setBackgroundResource(com.gelakinetic.mtgfam.R.drawable.in_fragment_menu_button);
            	((ImageButton)b).setImageResource(itemIconResId);
            }
            else {
            	b = new Button(mContext);
            	((Button)b).setBackgroundResource(com.gelakinetic.mtgfam.R.drawable.in_fragment_menu_button);
                ((Button)b).setText(itemTitle);
            }
            
            final float scale = mContext.getResources().getDisplayMetrics().density;
            int pixels = (int) (48 * scale + 0.5f); // 48dp to px
            @SuppressWarnings("deprecation")
			LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, pixels, 1.0f);
            b.setLayoutParams(lp);
            
            final InFragmentMenuItem mi = new InFragmentMenuItem(mContext);
            mi.setItemId(itemId);
            setItem(mi);
            b.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					mFragment.onOptionsItemSelected(mi);
				}
			});
            b.setOnLongClickListener(new OnLongClickListener() {
				...
				public boolean onLongClick(View v) {
					Toast.makeText(mi.getContext(), mi.getTitle(), Toast.LENGTH_SHORT).show();
					return true;
				}
			});
            mView.addView(b);
